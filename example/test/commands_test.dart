    ...
    test('prints all commands with status indicators', () async {
      ...
      expect(
        ...
        equals(
          ...
          '❌ ${bold}${red}invalid_typed_enum_int_string$reset:                     Parameter ${bold}${red}platform$reset expects an ${gray}[integer]$reset\n'
          '      Got: "ios" ${gray}[string]$reset\n'
          '❌ ${bold}${red}invalid_typed_enum_int_multi$reset:                      Parameter ${bold}${red}platform$reset expects an ${gray}[integer]$reset\n'
          '      Got: "ios" ${gray}[string]$reset, "2.2" ${gray}[double]$reset\n'
